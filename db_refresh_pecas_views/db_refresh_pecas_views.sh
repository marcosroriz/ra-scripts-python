...
echo "[start] db_refresh_pecas_views scheduler started"
...
while true; do
  (
    ...
    python -u /app/db_refresh_pecas_views.py >> "${LOG_DIR}/${DATE}-db_refresh_pecas_views.txt" 2>&1 || echo "[error] db_refresh_pecas_views failed"
