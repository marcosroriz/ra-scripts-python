...
echo "[start] down_tipos_eventos scheduler started"
...
while true; do
  (
    ...
    python -u /app/down_tipos_eventos.py >> "${LOG_DIR}/${DATE}-tipos-eventos.txt" 2>&1 || echo "[error] down_tipos_eventos failed"
