...
echo "[start] mix_update_veiculos scheduler started"
...
while true; do
  (
    ...
    python -u /app/mix_update_veiculos.py >> "${LOG_DIR}/${DATE}-veiculos.txt" 2>&1 || echo "[error] mix_update_veiculos failed"
